...
The script is colocated with this skill at `.Codex/skills/find-code-tasks/task-status.sh`.

Execute it with appropriate arguments:

```bash
# Default: table format, all tasks
.Codex/skills/find-code-tasks/task-status.sh

# With filter
.Codex/skills/find-code-tasks/task-status.sh --pending
.Codex/skills/find-code-tasks/task-status.sh --in_progress
.Codex/skills/find-code-tasks/task-status.sh --completed

# With format
.Codex/skills/find-code-tasks/task-status.sh --json
.Codex/skills/find-code-tasks/task-status.sh --summary

# Custom tasks directory
TASKS_DIR=tools/ .Codex/skills/find-code-tasks/task-status.sh
```
...
- Check the script exists: `ls .Codex/skills/find-code-tasks/task-status.sh`
- Make it executable: `chmod +x .Codex/skills/find-code-tasks/task-status.sh`
