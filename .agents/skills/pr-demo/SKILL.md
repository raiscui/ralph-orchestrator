...
Codex can self-validate demos using three approaches:
...
Extract a static frame for Codex to analyze:
...
# Codex can read GIF files with the Read tool
```

Then ask Codex to analyze using the Read tool on the image:
