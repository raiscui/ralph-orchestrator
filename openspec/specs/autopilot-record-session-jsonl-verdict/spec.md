# autopilot-record-session-jsonl-verdict Specification

## Purpose
TBD - created by archiving change autopilot-record-session-jsonl-verdict. Update Purpose after archive.
## Requirements
